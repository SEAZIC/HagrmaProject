 ...
 * PRE>ステート歯車
 * 属性：歯車
 *  行動パターンを保持し，アニメーションタイマーを使用してオブジェクトの歯車を管理する</PRE>
 */
public class StateHagrma extends Hagrma {
     ...
     * @param hagrma {@link Hagrma} 追加する歯車 ステータスごとに歯車を追加する </PRE>
     */
    ...
    /**
     * <PRE>次のステータスに移動するメソッド
     * 次ステータスの歯車があれば今オブジェクトに渡している歯車を消して次のステータスの歯車を追加する</PRE>
     */
    public void next() {
        if (isEmpty()) {
            return;
