...
//												if(vecy/vecx < (chipsize-sety)/(chipsize-setx)){
                                            ...
                                            } else if ((int) copyoldBox.getMinX() > (int) (mapPosx + chipsize)) {
                                                pushF[0] = true;
                                            }
                                        } else if ((int) copyoldBox.getMinY() >= (int) (mapPosy + chipsize) && vecy < 0) {
                                            pushF[2] = true;
                                        }
                                    }
...
//												if(vecy/vecx >= (chipsize-sety)/(setx)){
                                            ...
                                            } else if ((int) copyoldBox.getMaxX() <= (int) (mapPosx + (chipsize * (checkMap.length - 1)))) {
                                                pushF[1] = true;
                                            }
                                        } else if ((int) copyoldBox.getMinY() >= (int) (mapPosy + chipsize) && vecy < 0) {
                                            pushF[2] = true;
...
//													}else
                                        ...
                                        } else if ((int) copyoldBox.getMaxY() - 1 < (int) (mapPosy + (chipsize * (checkMap[0].length - 1))) && vecy >= 0) {
                                            pushF[3] = true;
                                        }
                                    }
...
//									((CollionHagrma)colhag).getParent().boxrefresh();
                                } else if (checkMap.length == 1 && checkMap[0].length == 1) {
